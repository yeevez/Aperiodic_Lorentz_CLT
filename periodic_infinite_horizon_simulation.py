...
for i in range(n_existing_samples+1,N_SAMPLES):
    filename = '2d_circular_obstacle_5milcollisions_periodiclattice_sample_' + str(i)
    flight_filename = '2d_circular_obstacle_5milcollisions_periodiclattice_sample_' + str(i) + '_flight_time'
